...
1. **Fork this repository**  
   Click [here](https://github.com/Sridatthu/datthuui/fork) to fork the repository.

2. **Clone your forked repository to your local machine**

   ```bash
   git clone https://github.com/<YOUR_USERNAME>/datthuui.git
   ```
...
To add a new component to datthuui, you will need to modify several files. Follow these steps:

### 1. Create Component

Create the main component in `registry/datthuui/example-component.tsx`
...
Provide a basic example to showcase your component in `registry/datthuui/example/example-component-demo.tsx`

```typescript
import ExampleComponent from '@/registry/datthuui/example-component'
...
title: Example Component
date: 2024-06-01
description: Example component for Datthu UI
author: datthuui
published: true
---
...
export const ui: Registry = [
  // ... existing components ...
  {
    ...
    files: [
      {
        path: "registry/datthuui/example-component.tsx",
        type: "registry:ui",
      },
    ],
