...
<Tabs defaultValue="cli">
  ...
  <TabsContent value="cli">
    ```bash 
    npx shadcn@latest add "https://datthuui.vercel.app/r/gradual-spacing-text.json"
    ```
  </TabsContent>
  <TabsContent value="manual">
    <Steps>
      ...
      `components/datthuui/gradual-spacing-text.tsx`
...
```tsx showLineNumbers
import { GradualSpacingText } from "@/components/datthuui/gradual-spacing-text"
```

```tsx showLineNumbers
<GradualSpacingText text="Welcome to DatthuUI" className="text-blue-600" />
```
