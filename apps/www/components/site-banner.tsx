      ...
      <div className="container flex flex-col items-center justify-center gap-4 md:h-12 md:flex-row">
        ...
        >
          ...
          <span className="ml-1 font-[580] dark:font-[550]">
            {" "}
            Introducing Datthu UI Pro - 50+ blocks and templates to build
...
export function ProductHuntBanner() {
  return (
    <div className="group relative top-0 bg-[#ff6154] py-3 text-white transition-all duration-300 md:py-0">
      <div className="container flex flex-col items-center justify-center gap-4 md:h-12 md:flex-row">
        <Link
          href="https://www.producthunt.com/posts/datthuui-2?utm_source=site-banner&utm_medium=banner&utm_campaign=product-hunt-banner"
        ...
        >
          ...
          <span className="ml-1 font-[580] dark:font-[550]">
            {" "}
            Datthu UI is live on Product Hunt Today! Show your support and vote
            for us.
          </span>{" "}
          <ChevronRight className="mt-[3px] ml-1 hidden size-4 transition-all duration-300 ease-out group-hover:translate-x-1 lg:inline-block" />
        </Link>
