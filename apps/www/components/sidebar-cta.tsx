...
import { AnimatedShinyText } from "@/registry/datthuui/animated-shiny-text"
import { AuroraText } from "@/registry/datthuui/aurora-text"
import { LineShadowText } from "@/registry/datthuui/line-shadow-text"
import { TextAnimate } from "@/registry/datthuui/text-animate"
    ...
    <div className="border-border my-6 flex w-full flex-col gap-4 rounded-xl border p-6">
      ...
      <div className="space-y-3">
        <p className="text-foreground text-2xl leading-tight font-bold">
          ...
          with <AuroraText>Datthu UI Pro</AuroraText>
        </p>
...
export function ProductHuntCTA() {
  return (
    <Link
      href="https://www.producthunt.com/posts/datthuui-2?utm_source=sidebar-cta&utm_medium=sidebar-cta&utm_campaign=product-hunt-sidebar-cta"
      target="_blank"
    ...
    >
      <TextAnimate animate="blurInUp" by="word" className="text-2xl">
        Vote for Datthu UI on Product Hunt Today!
      </TextAnimate>
